...
export const tasks = ["to read js", "to eat", "to sleep"];
...
export const deletList = (listId) => {
    const currentList = document.querySelector(`#${listId}`)
    // if(window.confirm("Are you sure to delete ?")) {
    //     currentList.classList.add("animate__animated", "animate__backOutRight")
...
export const editList = (listId) => {
    ...
    const listTask = currentList.querySelector(".list-task")
        ...
        newTaskInput.className = "border border-stone-950 px-2 py-1 w-[180px] focus-visible:outline-none"
